...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../public/css/gioithieu.css">
</head>
...
<body>
    ...
    <div class="gt">
        <h1><strong>GIỚI THIỆU VIV STORE</strong></h1>
        <h2>THÔNG TIN GIỚI THIỆU VỀ CỬA HÀNG VIV STORE</h2>
    </div>
    <div class="content">
        <div class="row">
            <div class="col-5">
            ...
            <p class="gioithieu5">Mặt hàng kinh doanh: máy tính bao gồm các thương hiệu như DELL, ASUS, LENOVO, MACBOOK , HP,...
                ...
                <br>VIV STORE là một cửa hàng quy mô nhỏ chuyên bán các loại máy tính, nhưng lại cung cấp đầy đủ, đa dạng các loại sản phẩm. Ưu thế lơn nhất của cửa hàng là phục vụ khách hàng 24/24, đây được xem là điểm cộng có thể đáp ứng được nhu cầu khách hàng.</br>
                <br>VIV STORE cam kết bán hàng chính hãng, sản phẩm vô cùng phong phú, đa dang
            </p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card d-flex mx-auto">
                ...
                <div class="dm"> <span id="name">VIV STORE<br></span> </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card d-flex mx-auto">
        ...
        <div class="col-md-4">
            <div class="card d-flex mx-auto ">
                ...
                <div class="card-text">
                    <div class="card-title">VIV STORE</div> 
